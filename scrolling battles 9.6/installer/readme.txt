...
Up: Jump (Hold left and right while jumping to move left or right. As you increase your speed, you jump in the air faster.)
...
As you know, you can create enemies. But, as of version 9.5, you can customize them to your liking. Just make a file in your enemy's folder called info.dat. Then, in this file, you can write any of the following.

speed
how fast the enemy walks. It in MS.
example: speed=200

attacktime
How fast the enemy attacks the player, in ms.
example: attacktime=1000
...
damage
How much damage an enemy gives when he hits you.
example: damage=25

hitrange
How far away an enemy hits from
example: hitrange=2

Making characters.
You can do the same thing with characters now. here are the info.dat settings

Jumpheight
Spesifies how high the player can jump.
Example: jumpheight=5

jumptime
Spesifies how fast the character jumps. Must be lower than 150 and higher than 25. It's in MS.
Example: jumptime=60

speed
How fast the character moves. Effects walking, running, and jumping. Experiment with this one a bit.
example: speed=240
